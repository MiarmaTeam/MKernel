...
import static net.miarma.toorbo.config.providers.CommandProvider.Arguments.WARPS;
import static net.miarma.toorbo.config.providers.CommandProvider.Arguments.WARP_NAME;
    ...
    public static void register() {
        ...
        new CommandAPICommand(warpCmd.getName())
            ...
            .executesPlayer((sender, args) -> {
                File f = new File(Toorbo.PLUGIN.getDataFolder().getAbsolutePath(), "warps/"
                        + sender.getName() + ".yml");
                    ...
                    .executes((sender, args) -> {
                        ...
                        if (c.contains(warpName)) {
                            ...
                            try {
                                ...
                                Toorbo.LOGGER.severe("Error al guardar el archivo de warps de " + sender.getName());
                            }
