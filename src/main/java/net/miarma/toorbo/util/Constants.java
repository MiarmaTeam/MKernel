...
public class Constants {
    ...
    public static NamespacedKey VANISH_KEY = new NamespacedKey(Toorbo.PLUGIN, "vanish");
    public static NamespacedKey SPY_KEY = new NamespacedKey(Toorbo.PLUGIN, "spy");
    public static NamespacedKey FROZEN_KEY = new NamespacedKey(Toorbo.PLUGIN, "frozen");
