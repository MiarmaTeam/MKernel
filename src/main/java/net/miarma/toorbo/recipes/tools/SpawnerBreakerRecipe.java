...
public class SpawnerBreakerRecipe {
	private static ItemStack crear() {
        ...
        meta.setDisplayName(MessageUtil.parseColors(Toorbo.CONFIG
        		.getString("language.items.spawnerBreaker.name")));
        meta.setLore(Collections.singletonList(MessageUtil.parseColors(Toorbo.CONFIG
    ...
    public static ShapedRecipe get() {
        ...
        NamespacedKey spawnerBreakerRecipeKey = new NamespacedKey(Toorbo.PLUGIN, SPAWNER_BREAKER_KEY);
