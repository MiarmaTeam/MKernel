...
public class GlobalChestCommand {
    public static void register() {
        new CommandAPICommand(CONFIG.getString("commands.globalchest.name"))
            .withOptionalArguments(PLAYERS_OPT_ARG.withPermission(
                    CONFIG.getString("commands.globalchest.permissions.others")
            ))
            .withFullDescription(CONFIG.getString("commands.globalchest.description"))
            .withPermission(CONFIG.getString("commands.globalchest.permissions.base"))
            .withShortDescription(CONFIG.getString("commands.globalchest.description"))
